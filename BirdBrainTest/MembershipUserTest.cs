...
namespace BirdBrainTest
{
    ...
    public class MembershipUserTest
    {
        ...
        {
            var user = new BirdBrainMembershipUser("test", "1", "derp@herp.com", "", "", true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            var otherUser = new BirdBrainMembershipUser("test", "1", "derp@herp.com", "", "", true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
        ...
        {
            var user = new BirdBrainMembershipUser("test", "1", "derp@herp.com", "", "", true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            var otherUser = new BirdBrainMembershipUser("othertest", "1", "derp@herp.com", "", "", true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
        ...
        {
            var user = new BirdBrainMembershipUser("test", null, "derp@herp.com", "", "", true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
